...
// in simulator we redefine to format for fb Developer console
...
{\
	NSString * exceptionName = [@"org.fb." stringByAppendingString:NSStringFromClass([self class])];\
...
enum {
	UIfbNativeItemNone = -1, 
	UIfbNativeItemSpinner = -2,
	UIfbNativeItemProgressBar = -3,
	
	UIfbNativeItemSlider = -4,
	UIfbNativeItemSwitch = -5,
	UIfbNativeItemMultiButton = -6,
	UIfbNativeItemSegmented = -7,
	
	UIfbNativeItemTextView = -8,
	UIfbNativeItemTextField = -9,
	UIfbNativeItemSearchBar = -10,
	
	UIfbNativeItemPicker = -11,
	UIfbNativeItemDatePicker = -12,
	
	UIfbNativeItemInfoLight = -13,
	UIfbNativeItemInfoDark = -14,
	
	UIfbNativeItemDisclosure = -15,
	
	UIfbNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all fb instances of
